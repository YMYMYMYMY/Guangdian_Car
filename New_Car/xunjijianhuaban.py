...
def run():
    ...
    binary_code_run = b'\x7B\x00\x00\x01\x00\x00\x00\x00\x00\x7A\x7D'
...
#0000 1111 and 0000 0111 and 0000 0011
        ...
        print(Tracking_1Value,Tracking_2Value,Tracking_3Value,Tracking_4Value,Tracking_5Value,Tracking_6Value,Tracking_7Value,Tracking_8Value)
        runn(b'\x7B\x00\x00\x00\x00\x00\x00\xFD\x00\x86\x7D')
        time.sleep(1.15)        
#wosjofenjiexian
...
#1111 0000 and 1110 0000 and 1100 0000
        ...
        print(Tracking_1Value,Tracking_2Value,Tracking_3Value,Tracking_4Value,Tracking_5Value,Tracking_6Value,Tracking_7Value,Tracking_8Value)
        runn(b'\x7B\x00\x00\x00\x00\x00\x00\xF1\x00\x8A\x7D')
        time.sleep(0.27)  
